defmodule TicTacToeWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {TicTacToeWeb.Layouts, :root}
  ...
  scope "/", TicTacToeWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TicTacToeWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TicTacToeWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{TicTacToeWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", TicTacToeWeb do
    ...
    live_session :current_user,
      on_mount: [{TicTacToeWeb.UserAuth, :mount_current_user}] do
